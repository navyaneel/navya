            ...
            <div class="row">
                        ...
                        <div class="lower">
                            <div class="lower-content">
                                ...
                                <div class="content">
                                    ...
                                    <a class="text-size-18 mb-0 text text-decoration-none" href="tel:+919901035744">+91 9901035744</a>
                                </div>
                            </div>
                            <div class="lower-content">
                                <figure class="icon">
                                ...
                                <div class="content">
                                    ...
                                    <a href="mailto:jeni@dewdastech.com" class="text-size-18 mb-0 text-decoration-none">jeni@dewdastech.com</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-2 col-md-3 col-sm-12 col-12 d-md-block d-none">
                    <div class="links list-pd">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li><a href="./about.php" class="text-size-18 text text-decoration-none">About</a></li>
                            <li><a href="./service.php" class="text-size-18 text text-decoration-none">Services</a></li>
                            <li><a href="./project-details.php" class="text-size-18 text text-decoration-none">Projects</a></li>
                            <li><a href="./contact.php" class="text-size-18 text text-decoration-none">Contact</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-12 col-12 d-lg-block d-none">
                    <div class="links">
                        ...
                        <ul class="list-unstyled mb-0">
                           <li><a href="index.php" class="text-size-18 text text-decoration-none">IT/Telecom</a></li>
                            <li><a href="./service.php" class="text-size-18 text text-decoration-none">Electronic design services</a></li>
                           <li><a href="./service.php" class="text-size-18 text text-decoration-none"> Automation</a></li>
                            <li><a href="./service.php" class="text-size-18 text text-decoration-none">Simulations</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row copyright-border">
                    <div class="col-lg-6 col-md-6 col-sm-12 co-12 column">
                        <p class="text-size-16">Copyright ©2025 dewdastech.com | All Rights Reserved</p>
                    </div>
